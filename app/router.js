module.exports = (function() {
  ...
  const DevicesController = Nodal.require('app/controllers/devices_controller.js');
  const LocationsController = Nodal.require('app/controllers/locations_controller.js');
  ...
  router.route('/devices/{id}').use(DevicesController);
  router.route('/locations/{id}').use(LocationsController);
